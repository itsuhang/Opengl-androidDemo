...
import com.suhang.opengldemo.render.OpenGlRenderEight;
import com.suhang.opengldemo.render.OpenGlRenderSeven;
...
public class GLFragmentEight extends Fragment {
	@Override
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
		...
		glsv.setRenderer(new OpenGlRenderEight(getContext()));
