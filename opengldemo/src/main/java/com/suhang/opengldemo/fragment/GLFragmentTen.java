...
import com.suhang.opengldemo.render.OpenGlRenderNine;
import com.suhang.opengldemo.render.OpenGlRenderTen;
...
public class GLFragmentTen extends Fragment {
	@Override
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
		...
		glsv.setRenderer(new OpenGlRenderTen(getContext()));
